...
export const CITATIONS: readonly Citation[] = [
  ...
  {
    id: 'services.rwh.building-plan',
    rule: 'services.rainwater-harvesting',
    clause: 'Clause 13.1.2 (Requirements of Building Plan)',
    supports:
      'RWH_PLOT_AREA_SQM, applied inclusively. Also the waterlogged-area exception, which bars recharge and substitutes roof collection rather than lifting the obligation.',
    gazettePage: 128,
    kind: 'prose',
    line: 8864,
    text: 'In case of no collective recharge network, roof top rainwater harvesting system in plots of all uses of 300 square meters and more area (including group housing) except waterlogged areas. Construction of rainwater harvesting structures shall be ensured as per standard technology and rainwater shall be allowed to penetrate the soil to the minimum required depth so that the problem of pollution of ground water sources does not arise. Ground water recharging system should not be adopted in areas with water logging problem, but arrangements can be made to collect rainwater received from the roofs of buildings.',
  },
  {
    id: 'services.rwh.layout-exemption',
    rule: 'services.rainwater-harvesting',
    clause: 'Clause 13.1.2(f)',
    supports:
      'RWH_COLLECTIVE_EXEMPTION_BAND_SQM — the 100-300 m² exemption is conditional on a collective recharge network, and above 300 m² the network does not discharge the owner.',
    gazettePage: 128,
    kind: 'prose',
    line: 8862,
    text: 'In the layout plans of new schemes, for plots of areas from 100-300 square meters, it shall not be mandatory to establish rainwater harvesting system in individual buildings if the rainwater from group of buildings flows into the network of the collective recharge of the scheme. However, in relation to buildings constructed on plots of area more than 300 square meters, then it shall be mandatory for the building owner to install rainwater harvesting system himself.',
  },
  {
    id: 'services.rwh.category-conditions',
    rule: 'services.environmental-conditions',
    clause: 'Clause 13.1.2 (environmental conditions)',
    supports:
      'RECHARGE_BORE_PER_BUILT_UP_SQM and the water conditions of ENVIRONMENTAL_CONDITIONS. The requirement cell is merged across Category-A, B and C — B and C print empty — and a second Category-C row headed "Additional Conditions" carries what C adds.',
    gazettePage: 128,
    kind: 'cells',
    lines: [8866, 8885],
    cells: [
      ...
      'Category-B (20000 -50000 sqm)',
      'Category-C (50000-150000 sqm)',
  ...
  {
    id: 'services.solar-pv.trigger',
    rule: 'services.solar-pv',
    clause: 'Clause 13.2.3.1',
    supports:
      'SOLAR_PV_PLOT_AREA_SQM, inclusive. This is the plot-size trigger B-035 had requiring solar water heating.',
    gazettePage: 129,
    kind: 'prose',
    line: 8899,
    text: 'All plots having size 500 sqm and above shall install solar photovoltaic power generation system. This should also be encouraged for plots smaller than 500 sqm. The power generated may be used for in-house utilization or for transfer to the grid.',
  },
  {
    id: 'services.solar-water-heating.scope',
    rule: 'services.solar-water-heating',
    clause: 'Clause 13.2.3.2',
    supports:
      'SOLAR_WATER_HEATING_CATEGORIES and the hot-water condition. The trigger is the building category; the clause states no plot, area or height threshold anywhere.',
    gazettePage: 129,
    kind: 'prose',
    line: 8901,
    text: 'No new building in the following categories in which there is a system of installation for supplying hot water shall be built unless the system of the installation is also having an auxiliary solar assisted water heating system. Solar water heating systems shall be provided in the following buildings:',
  },
  {
    id: 'services.solid-waste.bins',
    rule: 'services.solid-waste',
    clause: 'Clause 13.4',
    supports:
      'SOLID_WASTE_NON_RESIDENTIAL_SQM, and the universal segregation duty in the clause’s first sentence. The 500 m² qualifier attaches to non-residential buildings only.',
    gazettePage: 130,
    kind: 'prose',
    line: 8948,
    text: 'All buildings shall provide facilities for solid waste management with segregation of dry and wet waste at source. For waste management in residential buildings (including group housing) and all non-residential buildings with an area of more than 500 square meters, two types of dustbins (biodegradable and non-biodegradable) shall be provided on the ground floor near the entrance of the plot so that it becomes easy for the local body to collect garbage from dustbins every day, de-process it at ward or sector level and prepare fuel cake, fertilizer, paper etc.',
  },
  {
    id: 'services.wastewater.trigger',
    rule: 'services.environmental-conditions',
    clause: 'Clause 13.5',
    supports:
      'WASTEWATER_RECYCLING_LPD. Reported as unresolved rather than evaluated: the byelaws give no figure to estimate discharge from and the project model holds no occupant load (V-042).',
    gazettePage: 130,
    kind: 'prose',
    line: 8971,
    text: 'A wastewater recycling facility shall be installed wherever the minimum estimated water discharge from the building(s) on a plot exceeds 10,000 liters per day.',
  },
  {
    id: 'services.trees.residential',
    rule: 'services.tree-plantation',
    clause: 'Clause 13.7(a)(iv)',
    supports:
      'The residential ladder above 500 m² — one tree per 100 m² "or part thereof", which is why the count is rounded up.',
    gazettePage: 132,
    kind: 'prose',
    line: 9023,
    text: 'One tree per 100 square meter area or part thereof in a plot of area more than 500 square meter.',
  },
  {
    id: 'services.trees.group-housing',
    rule: 'services.tree-plantation',
    clause: 'Clause 13.7(a)(v)',
    supports:
      'The group housing rate, 50 trees per hectare of scheme area — the one residential figure not keyed on the plot-area ladder.',
    gazettePage: 132,
    kind: 'prose',
    line: 9024,
    text: '50 trees per hectare in group housing scheme.',
  },
  {
    id: 'services.trees.industrial',
    rule: 'services.tree-plantation',
    clause: 'Clause 13.7(b)',
    supports:
      'The industrial rate, one tree per 80 m² of plot — the same rate the Category-A environmental condition applies to every use.',
    gazettePage: 132,
    kind: 'prose',
    line: 9027,
    text: 'One tree per 80 square meter plot of land.',
  },
  {
    id: 'services.trees.commercial',
    rule: 'services.tree-plantation',
    clause: 'Clause 13.7(c)',
    supports:
      'The commercial rate, one tree per 100 m², also applied to office buildings by analogy because Clause 13.7 names no fifth category (V-044).',
    gazettePage: 132,
    kind: 'prose',
    line: 9030,
    text: 'One tree per 100 square meter area.',
  },
  {
    id: 'services.trees.institutional',
    rule: 'services.tree-plantation',
    clause: 'Clause 13.7(d)',
    supports:
      'The institutional rate. "Greenery on a minimum of 20% of the total area where trees shall be planted at the rate of 125 trees per hectare" is read against the total area, which is the stricter of the two readings.',
    gazettePage: 132,
    kind: 'prose',
    line: 9033,
    text: 'There shall be greenery on a minimum of 20% of the total area where trees shall be planted at the rate of 125 trees per hectare.',
  },
  {
    id: 'services.trees.chapter-3-parallel',
    rule: 'services.tree-plantation',
    clause: 'Chapter 3, Landscape Plan',
    supports:
      'The conflicting statement V-044 records: Chapter 3 rates the same obligation per hectare of open space, Chapter 13 per square metre of plot. The engine holds Chapter 13’s, which is much the stricter.',
    gazettePage: 39,
    kind: 'prose',
    line: 1573,
    text: 'Minimum 20 percent of the total open space in the commercial scheme shall have trees planted at the rate of minimum 50 trees per hectare.',
  },
  {
    id: 'services.eia.clearance',
    rule: 'services.environmental-conditions',
    clause: 'Clause 13.8',
    supports:
      'The Environment Clearance gate, and the Category-D band. Category-A prints "-"; B and C share one merged cell; D addresses townships and area development projects in the same terms.',
    gazettePage: 133,
    kind: 'cells',
    lines: [9057, 9073],
    cells: [
      ...
      '-',
      'Category-B (20000 -50000 sqm)',
      'No development permission shall be given to the Building and Construction projects, until getting Environment Clearance from SEIAA (State Level Environment Impact Assessment Authority) as required under the Environmental Impact Assessment notification-2006 and amended from time to time.',
      'If the developer wishes to split the project into phases, developer has to produce Environment Clearance from SEIAA, prior to the approval of first phase of the project.',
      'Category-C (50000-150000 sqm)',
      'Category-D (>150000 sqm or Site Area >50 Ha)',
      'No development permission shall be given to the Townships and Area Development projects until getting Environment Clearance from SEIAA (State Level Environment Impact Assessment Authority) as required under the Environmental Impact Assessment notification-2006 and amended from time to time.',
      'If the developer wishes to split the project into phases, developer has to produce Environment Clearance from SEIAA, prior to the approval of first phase of the project.',
    ],
  },
  {
    id: 'services.emp.preamble',
    rule: 'services.environmental-conditions',
    clause: 'Clause 13.9',
    supports:
      'The sentence that settles V-043: the Environment Management Plan is stated for "all buildings above 50,000 sqm built up area" against a table whose only row is printed "50000-150000 sqm", so the Category-C row is open above and Category-D inherits it.',
    gazettePage: 133,
    kind: 'prose',
    line: 9076,
